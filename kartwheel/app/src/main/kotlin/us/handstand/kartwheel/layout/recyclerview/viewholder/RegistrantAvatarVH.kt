...
class RegistrantAvatarVH private constructor(val parent: ViewGroup) : AdapterVH(parent) {
    ...
    private val avatarView: CircularImageView = parent.findViewById(R.id.avatar)
    private val firstName: TextView = parent.findViewById(R.id.firstName)

    companion object {
        fun constructNewInstance(parent: ViewGroup): RegistrantAvatarVH =
                RegistrantAvatarVH(LayoutInflater.from(parent.context).inflate(R.layout.recycler_view_holder_registrant_avatar, parent, false) as ViewGroup)
