...
class AlreadyClaimedFragment : Fragment(), TicketActivity.TicketFragment, View.OnClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        fragmentViewGroup.findViewById(R.id.alreadyClaimedLink).setOnClickListener(this)
        fragmentViewGroup.findViewById(R.id.additionalButton).setOnClickListener(this)
        return fragmentViewGroup
    }

    override fun getTitleResId(): Int {
        return R.string.already_claimed_title
    }

    override fun getAdvanceButtonTextResId(): Int {
        return R.string.try_different_code
    }
    ...
    override fun onClick(v: View) {
        if (v.id == R.id.alreadyClaimedLink) {
