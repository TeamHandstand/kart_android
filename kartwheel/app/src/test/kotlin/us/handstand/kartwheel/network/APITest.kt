...
class APITest {
    ...
    private val ticketId = "212c5182-4ee4-402b-b7ae-784ecfb4b90e"
    ...
    private val eventResponse = "{\"event\":{\"id\":\"$eventId\",\"endTime\":\"2017-05-19 03:07:43.537977\",\"startTime\":\"2017-05-17 03:07:43.537428\",\"name\":\"kartwheel\",\"createdAt\":\"2017-05-17 03:07:43.559896\",\"updatedAt\":\"2017-05-17 03:07:43.559896\",\"usersCanSeeRaces\":\"true\"}}"
    private val birth = "1989-07-25 00:00:00.000"
    ...
    fun claimTicket() {
        ...
        server.enqueue(MockResponse().setBody(eventResponse))
        ...
        assertThat(Storage.ticketId, CoreMatchers.`is`(ticketId))
